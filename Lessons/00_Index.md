...
## Process Lessons — Claude Code Workflow

These lessons teach **how to build any project using Claude Code** — the tools, commands, phases, and prompt discipline. Read these before or alongside the content lessons. Generated by `/workflow-lesson-gen`.

| Lesson | Title | Evidence Source | Status |
|--------|-------|----------------|--------|
| P01 | [The Incident Responder's Runbook — What Was Actually Done](LessonP01_Claude_Code_Investigation_Workflow.md) | `docs/exploration-log.md`, git log, `docs/prompt-experiments.md` | ✅ Complete |
| P02 | [The Engineering Playbook — Optimal Workflow for Any Project](LessonP02_Optimal_Claude_Code_Workflow.md) | P01 gap analysis + project type classification | ✅ Complete |

---

## Content Lessons — BackdoorBox Codebase
